        ...
        >
          <VStack ml={4} alignItems={"start"} width={"70%"} spacing={2}>
            ...
            <Text color={"black"}>
              ...
              <Text as={"u"}>
                <Link
                  href={"https://cs.nyu.edu/courses/fall22/CSCI-GA.3033-078/"}
                  isExternal={true}
                >
                  {"CSCI-GA.3033-078"}
                </Link>
            ...
            <Text color={"black"} as={"b"}>
              This site supports and only supports MetaMask with Georil test
              network for now. If you want to test our features and get a test
              net token, please switch your Metamask wallet to Georil test
              network before you do that. We did not test it on Ethereum Mainnet
              and do not guarantee what will happen.
            </Text>
            <Text color={"black"}>
              You may experience some visual glitches on your phone as this site
              is not optimized for mobile accessing.
            </Text>
            <Text color={"black"}>
