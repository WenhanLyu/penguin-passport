                  ...
                  <>
                    <GridItem area={"nav"}>
                      <Stack spacing={3}>
                        ...
                        <Text fontSize={"sm"}>
                          Follow these easy steps! First, choose your wallet and
                          connect it.
                        </Text>
                      </Stack>
                      {/*<Divider mt={'10px'}/>*/}
                  ...
                  <>
                    <GridItem area={"nav"}>
                      <Stack spacing={3}>
                        ...
                        <Text fontSize={"sm"}>
                          Please approve the connection in your wallet and
                  ...
                  <>
                    <GridItem area={"nav"}>
                      <Stack spacing={3}>
                        ...
                        <Text fontSize={"sm"}>
                          You have connected your wallet, now start using our
                          app!
                        </Text>
                      </Stack>
                      {/*<Divider mt={'10px'}/>*/}
